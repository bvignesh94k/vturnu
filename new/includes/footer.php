    ...
    <div class="container">
        <div class="footer-top">
            <div class="footer-brand-col">
                <img src="/assets/img/vturnu-logo-transparent.png" alt="<?= e(SITE_NAME) ?> logo" width="180" height="60" loading="lazy" decoding="async">
...
<dialog class="quote-modal" id="quote-modal" aria-labelledby="qm-title">
    ...
    <div class="qm-body">
        ...
        <form class="contact-form qm-form" method="post" action="/contact-us/">
            ...
            <div class="form-grid">
                <div class="form-row"><label for="qm-phone">Phone / WhatsApp</label><input id="qm-phone" name="phone" type="tel" placeholder="+91 …" value="<?= e($visitor_dial_code) ?> " autocomplete="tel"></div>

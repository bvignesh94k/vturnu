...
$related = [];
foreach ($CASES as $rslug => $r) {
    if ($rslug !== $page['case']) { $related[$rslug] = $r; if (count($related) >= 3) break; }
}
...
<div class="case-results-band">
    <div class="container case-results-inner">
        ...
        <div class="case-metric" data-reveal>
...
<section class="section section-tint">
    <div class="container">
        ...
        <div class="card-grid cols-2">
            ...
            <div class="card svc-card <?= $accents[$i % 4] ?>" data-reveal>
...
<section class="cta-mid">
    <div class="container cta-mid-inner">
        ...
        <div class="cta-mid-actions">
            <a class="btn btn-dark" href="/contact-us/">Start With a Free Audit</a>

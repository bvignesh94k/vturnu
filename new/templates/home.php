...
<section class="vturnu-hero" id="top">
    <div class="hero-main">
        <div class="hero-left">
            ...
            <h1 class="hero-h1">
                <span>V</span> turn <span>Ur</span> <br>ideas <em>into revenue</em>
            </h1>
            ...
            <div class="hero-ctas">
                ...
                <a class="btn btn-secondary" href="/free-seo-audit/">Free Website Audit Tool</a>
        ...
        <div class="hero-right">
            <div class="viz-dash" aria-hidden="true">
                <div class="dash-head">
                    <span class="dash-brand"><img src="/assets/img/vturnu-logo-transparent.png" alt="" width="22" height="22"> Growth Dashboard</span>
    ...
    <div class="container trustbar-inner">
        ...
        <div class="marquee-mask" aria-hidden="true">
            <div class="marquee-track">
                <?php $clients = ['AURELIA JEWELS', 'NEXKART', 'MEDIBLOOM CLINICS', 'SOUTHBAY REALTY', 'KAIROS FITNESS', 'VELLORE FOODS']; ?>
                <?php foreach (array_merge($clients, $clients) as $c): ?><span><?= e($c) ?></span><?php endforeach; ?>
            </div>
        </div>
    </div>
</section>
...
<section class="section" id="services">
    <div class="container">
        ...
        <div class="card-grid cols-3 svc-grid">
            ...
            <a class="card svc-card <?= $accent ?>" href="<?= e($url) ?>" data-reveal>
...
<section class="section why-band" id="results">
    <div class="container split">
        ...
        <div class="why-stats">
            <div class="why-stat ac-yellow" data-reveal><span class="counter grad-text" data-count="80" data-suffix="%+">80%+</span><small>average organic traffic growth within 6–9 months</small></div>
            <div class="why-stat ac-pink" data-reveal><span class="counter grad-text" data-count="50" data-suffix="%+">50%+</span><small>ROAS growth on Google &amp; Meta ad accounts we manage</small></div>
            <div class="why-stat ac-cyan" data-reveal><span class="counter grad-text" data-count="5" data-suffix="+">5+</span><small>years growing brands across India, US, UK &amp; Australia</small></div>
            <div class="why-stat ac-purple" data-reveal><span class="counter grad-text" data-count="10" data-suffix="+">10+</span><small>end-to-end projects delivered: web, app &amp; brand</small></div>
        </div>
    </div>
</section>
...
<section class="section" id="process">
    <div class="container">
        ...
        <div class="proc-grid">
            ...
            <div class="proc-card <?= $accent ?>" data-reveal>
...
<section class="section section-tint" aria-label="Client testimonials">
    <div class="container">
        ...
        <div class="card-grid cols-3">
            ...
            <figure class="card tsm-card" data-reveal>
...
<section class="quote-band" id="quote">
    <div class="container quote-inner">
        <div class="quote-copy" data-reveal>
            ...
            <?php else: ?>
                ...
                <form class="contact-form raw-lead-form" method="post" action="/#quote">
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-row"><label for="q-phone">Phone / WhatsApp</label><input id="q-phone" name="phone" type="tel" placeholder="+91 …" value="<?= e($visitor_dial_code) ?> " autocomplete="tel"></div>
                    </div>
                    <div class="form-row">

...
<section class="section section-tint" id="services">
    <div class="container">
        ...
        <div class="card-grid cols-3 svc-grid">
            ...
            <a class="card svc-card <?= $accents[$i % count($accents)] ?>" href="<?= e(page_url($child)) ?>" data-reveal="card">
...
<section class="section">
    <div class="container">
        ...
        <div class="proc-grid">
            ...
            <div class="proc-card <?= ['accent-yellow', 'accent-cyan', 'accent-pink', 'accent-purple'][$i % 4] ?>" data-reveal="card">

...
'business-content-engine' => [
    ...
    'title' => 'The B2B Content Engine (Free E-book): Pipeline Playbook',
...
'complete-guide-to-ecommerce-platforms' => [
    ...
    'table' => [
        'caption' => 'Ecommerce platforms compared',
        'head' => ['Platform', 'Best fit', 'SEO control', 'Main trade-off'],
        'rows' => [
            ['Shopify', 'Fast launches and lean teams', 'Good, but URL structure is fixed', 'App subscriptions and payment margins add up'],
            ['WooCommerce', 'Content-led stores already on WordPress', 'Full, nothing is locked', 'You own hosting, security and performance'],
            ['Magento / Adobe Commerce', 'Large or complex catalogs, B2B rules', 'Full, highly configurable', 'Needs real developer capacity to run'],
            ['BigCommerce', 'Mid-market stores wanting fewer apps', 'Good, more native control than Shopify', 'Smaller ecosystem and theme selection'],
            ['Headless', 'Custom experiences and multi-channel selling', 'Total, if built correctly', 'Highest build cost; SEO is easy to get wrong'],
        ],
    ],

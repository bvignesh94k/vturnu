...
$NAV = [
    ...
    [
        ...
        'columns' => [
            ...
            [
                ...
                'items'   => [
                    ['VTurnAI: Visibility Tool', '/ai-visibility-tool/', 'Our platform · ₹499/mo'],
        ...
        /* The mega-menu highlight now sends this intent to our own product
           instead of the contact form: someone browsing the AI Search menu is
           asking exactly the question VTurnAI answers, and a self-serve trial
           converts that curiosity far better than a "we'll get back to you". */
        'promo' => ['Our product', 'What does AI say about you?', 'VTurnAI tracks how ChatGPT, Gemini, Perplexity and AI Overviews present your brand. Free for 7 days.', 'See VTurnAI', '/ai-visibility-tool/'],
    ],
    ...
    [
        ...
        'columns' => [
            [
                'heading' => 'Tools & Learning',
                'items'   => [
                    ['VTurnAI Visibility Tool', '/ai-visibility-tool/', 'Track your brand in AI answers'],
